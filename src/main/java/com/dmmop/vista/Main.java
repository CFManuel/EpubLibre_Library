...
package com.dmmop.vista;

import com.dmmop.controller.UpdateDB;
import com.dmmop.daosqlite.ConnectorHelper;
...
import com.dmmop.vista.controllers.BookViewer;
import com.dmmop.vista.controllers.MainTableViewController;
import com.dmmop.vista.controllers.RootLayoutController;
...
public class Main extends Application implements CommonStrings {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        this.primaryStage
                .getIcons()
                .add(new Image("images/EPL_Portadas_NEGRO.png"));
    ...
    public void launchBook(Libro libro, int pos) {
        try {
            ...
            loader.setLocation(getClass().getClassLoader().getResource("BookViewer.fxml"));
    ...
    /**
     * Inicia la tabla de com.dmmop.vista y busqueda de libros.
     */
    private void initMainTableView() {
        try {
            FXMLLoader loader = new FXMLLoader();
            // Se indica la situación del xml gráfico.
            loader.setLocation(getClass().getClassLoader().getResource("MainTableView.fxml"));
            // Se carga el contenedor, en este caso un AnchorPane.
            AnchorPane pane = loader.load();
            // Se integra en la parte central del RootLayout.
            pane.setMaxSize(Double.MAX_VALUE, Double.MAX_VALUE);
            rootLayout.setCenter(pane);
            // Se indica el tamaño del root para que se ajuste a la com.dmmop.vista de datos.
